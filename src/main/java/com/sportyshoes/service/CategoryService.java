...
import com.sportyshoes.dto.CategoryPageInfo;
import com.sportyshoes.exceptions.CategoryNotFoundException;
...
public class CategoryService {
	...
	public String checkUnique(Integer id, String name, String url) {
		...
		if (isCreatingNew) {
			if (categoryByName != null) return "DuplicateName";
				Category categoryByUrl = repo.findByUrl(url);
				if (categoryByUrl != null) return "Duplicateurl";
			}else {
			if (categoryByName != null && categoryByName.getId() != id) {
				return "DuplicateName";
			}
			Category categoryByUrl = repo.findByUrl(url);
			if (categoryByUrl != null && categoryByUrl.getId() != id) {
				return "Duplicateurl";
			}
		}
